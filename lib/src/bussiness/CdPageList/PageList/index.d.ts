export declare const CdPageList: import("@chuangda/utils/dist/lib/withinstall").SFCWithInstall<import("vue").DefineComponent<{
    pageSize: {
    ...
    showOtherQueryPanel: boolean;
    showFold: boolean;
}, {}>>;
export default CdPageList;
