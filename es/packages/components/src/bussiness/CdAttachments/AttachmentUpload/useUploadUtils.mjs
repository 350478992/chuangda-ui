...
function C() {
  const l = {
    ...
    const { attitle: e, attClass: a, attCategory: s, attrefsysid: c, atttype: o } = t, r = e ? encodeURI(e) : "", i = a ? encodeURI(a) : "", u = s ? encodeURI(s) : "", d = c ? encodeURI(c) : "", h = o ? encodeURI(o) : "", $ = _(), f = l[n];
    return `${window.$baseRequestUrl}${f}?attitle=${r}&attClass=${i}&attCategory=${u}&attrefsysid=${d}&atttype=${h}&__sid=${$}`;
  }, p = (t) => new Promise((n, e) => {
    try {
      import("../../../../../../node_modules/.pnpm/ali-oss@6.17.1/node_modules/ali-oss/dist/aliyun-oss-sdk.mjs").then((a) => a.a).then((a) => {
        const s = a.default;
        S(t).then((c) => {
