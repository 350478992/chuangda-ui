import { defineComponent as $, useAttrs as F, computed as L, reactive as D, ref as U, provide as A, resolveComponent as c, openBlock as u, createBlock as m, withCtx as s, createVNode as o, unref as v, createElementVNode as T, createTextVNode as V, createCommentVNode as C, mergeProps as R } from "vue";
...
const E = { style: { display: "flex" } }, ee = /* @__PURE__ */ $({
  __name: "index",
  props: {
