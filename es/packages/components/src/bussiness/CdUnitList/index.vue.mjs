...
const X = T({ name: "cd-unit-list" }), se = /* @__PURE__ */ T({
  ...X,
  props: {
    modelValue: Boolean,
    equclacode: {
  ...
  setup(h, { emit: p }) {
    const t = h, c = I({
      ...
      isAnd: t.isAnd,
      isUse: "1"
    }), { useTableViewNo: A, useTitle: H, usePermission: F } = W(t), U = A, N = H, v = F;
    ...
    return (i, e) => {
      const f = r("Input"), C = r("Form-item"), y = r("Col"), O = r("Row"), g = r("Button"), R = $("hasPermission");
      return u(), D(z, null, [
        a(s(G), {
          class: "cd-unit-list",
          modelValue: c.value,
        ...
        l.visible ? (u(), b(K, {
          ...
          default: o(({ formProps: n, afterSave: L }) => [
            x(i.$slots, "unitform", {
              formProps: n,
              afterSave: L
            })
